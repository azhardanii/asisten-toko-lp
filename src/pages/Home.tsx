...
export default function Home() {
  ...
  return (
    <div ref={appRef}>
          ...
          <div className="pricing-grid reveal">
            ...
            <div className="pricingcard">
              ...
              <div className="plan-features">
                ...
                <div className="plan-feature"><span className="check">✓</span> Bebas Scan Tanpa Batas</div>
                <div className="plan-feature"><span className="check">✓</span> Pencatatan Transaksi Otomatis</div>
                <div className="plan-feature"><span className="check">✓</span> Fitur Cetak Struk Belanja</div>
            ...
            <div className="pricingcard popular">
              ...
              <div className="plan-features">
                <div className="plan-feature"><span className="check">✓</span> Masa Aktif 3 Bulan</div>
                <div className="plan-feature"><span className="check">✓</span> Akses Semua Fitur AsistenToko</div>
                <div className="plan-feature"><span className="check">✓</span> Bebas Scan Tanpa Batas</div>
                <div className="plan-feature"><span className="check">✓</span> Lebih Praktis (Bebas Tagihan Bulanan)</div>
                <div className="plan-feature"><span className="check">✓</span> Setara Rp 73.000/bulan (Lebih Murah)</div>
                <div className="plan-feature"><span className="check">✓</span> Support via WhatsApp</div>
              </div>
            ...
            <div className="pricingcard">
              ...
              <div className="plan-features">
                <div className="plan-feature"><span className="check">✓</span> Masa Aktif 1 Tahun</div>
                <div className="plan-feature"><span className="check">✓</span> Akses Semua Fitur AsistenToko</div>
                <div className="plan-feature"><span className="check">✓</span> Bebas Scan Tanpa Batas</div>
                <div className="plan-feature"><span className="check">✓</span> Fokus Jualan (Tanpa Perpanjang Bulanan)</div>
                <div className="plan-feature"><span className="check">✓</span> Setara Rp 58.250/bulan (Paling Hemat)</div>
                <div className="plan-feature"><span className="check">✓</span> Support Prioritas via WhatsApp</div>
              </div>
      ...
      <section className="final-cta">
        <div className="final-cta-content">
          ...
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <a href="https://wa.me/6285121963721?text=Haloo%20kak,%20aku%20mau%20nanya%20soal%20AsistenToko" target="_blank" rel="noopener noreferrer" className="btn-ghost" style={{ fontSize: '17px', padding: '16px 36px', borderColor: 'rgba(255,255,255,0.3)', color: 'white', background: 'rgba(255,255,255,0.1)' }}>
              Tanya Admin
          ...
          <div className="footer-grid">
            ...
            <div className="footer-links-wrapper">
              ...
              <div>
                ...
                <a href="https://wa.me/6285121963721?text=Haloo%20kak,%20aku%20mau%20nanya%20soal%20AsistenToko" target="_blank" rel="noopener noreferrer" className="footer-link">WhatsApp Support</a>
      ...
      `}</style>
      <a href="https://wa.me/6285121963721?text=Haloo%20kak,%20aku%20mau%20nanya%20soal%20AsistenToko" target="_blank" rel="noopener noreferrer" className="wa-float" aria-label="Hubungi Admin WhatsApp">
